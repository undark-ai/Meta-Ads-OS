...
- **checkout-cro**: For e-commerce cart and checkout flows rather than account registration
- **ux-audit**: For form usability, accessibility, and mobile defects in the flow
