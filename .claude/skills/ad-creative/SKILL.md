...
- **meta-creative-strategy**: For e-commerce/D2C Meta creative planning — creative-as-targeting, customer-situation angles, concept testing, and UGC strategy (part of the meta-ads suite)
- **ad-headline-techniques**: For named headline techniques (Wake-Up Call, Tricky Threes, Reveals, and more) and the six structural formulas by funnel stage, rather than general creative iteration
